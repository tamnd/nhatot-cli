...
Most of these come down to network reality or how nhatot serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nhatot rate-limits like any public site. nhatot already paces
...
Where a surface is gated, nhatot reads a cookie or token you supply
...
`nhatot`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nhatot actually did
